...
setwd("Users/jessicablack/Desktop/DSC/DSC520/R Projects/dsc520/data/")
...
covid_df <- read.csv("Users/jessicablack/Desktop/DSC/DSC520/R Projects/dsc520/data/nytimes/covid-19-data/us-states.csv")
...
ggplot(data=florida_df, aes(x=date, group=1)) +
    geom_line(aes(y = cases), color = "yellow") +
    geom_line(data=ny_df, aes(y = cases), color = "blue") +
    geom_line(data=california_df, aes(y = cases), color = "red")
